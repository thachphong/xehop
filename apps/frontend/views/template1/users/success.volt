			...
			<div class="pn_posts">
				...
				<div class="pn_content pn_background pn_border_2 login_form">
					...
					<div class="row row-margin-bottom" style="text-align: center;">
							...
							<label>Chúc mừng bạn đã đăng kí thành công tài khoản trên {{ constant("DOMAIN_NAME") }}!</label>
							<label>Có 1 email được gửi vào địa chỉ mail của bạn, vui lòng kiểm tra mail để kích hoạt tài khoản</label>
						</div>
